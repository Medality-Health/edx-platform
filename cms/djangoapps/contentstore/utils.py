...
def get_library_context(request, request_is_json=False):
    ...
    from cms.djangoapps.contentstore.views.library import (
        LIBRARIES_ENABLED,
        user_can_view_create_library_button, # @medality_custom
    )
    ...
    if not request_is_json:
        return {
            **data,
            ...
            'show_new_library_button': user_can_view_create_library_button(request.user) and request.user.is_active, # @medality_custom
            'user': request.user,
